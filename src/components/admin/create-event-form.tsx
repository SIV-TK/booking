...
const eventFormSchema = z.object({
  ...
  type: z.enum(
    ["Open Day", "Parent-Teacher Meeting", "Special Activity"],
...
export default function CreateEventForm({ onEventCreated }: CreateEventFormProps) {
  ...
  function onSubmit(data: EventFormValues) {
    const teacherIds = usersData.filter(u => u.role === 'teacher').map(t => t.id);
    ...
    const newEvent: Event = {
      ...
      icon:
        data.type === "Open Day"
          ...
          ? Presentation
          : BookOpen,
      availableSlots: generateSlots(data.date, teacherIds, 9, 17, 30),
    };
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Special Activity">
                    Special Activity
                  </SelectItem>
                </SelectContent>
              </Select>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Provide a URL for the event's banner image. Use picsum.photos for placeholders.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
